...
final class HttpsClient {
    ...
    public static function postForm($requestURL, $params) {
        ...
        $msg = "Time: " . var_export(($endTime - $start_time), true) . "\tRequestURL: " . var_export($requestURL, true);
        $msg .= "\tParams" . var_export($params, true);
        CommonTool::debugLog($msg, 'jingdong_api');
    ...
    public static function postJson($requestURL, $payload) {
        ...
        $endTime = CommonTool::getMillisecond();
        $msg = "Time: " . var_export(($endTime - $start_time), true) . "\tRequestURL: " . var_export($requestURL, true);
        $msg .= "\tParams" . var_export($payload, true);
        CommonTool::debugLog($msg, 'jingdong_api');
