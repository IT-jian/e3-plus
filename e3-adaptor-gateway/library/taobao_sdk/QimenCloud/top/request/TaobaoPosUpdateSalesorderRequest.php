<?php
/**
 * TOP API: qimen.taobao.pos.update.salesorder request
 * 
 * @author auto create
 * @since 1.0, 2019.10.16
 */
class TaobaoPosUpdateSalesorderRequest
{
	/** 
	 * 作废人
	 **/
	...
	public function setFhckCode($fhckCode)
	{
		$this->fhckCode = $fhckCode;
		$this->apiParas["fhck_code"] = $fhckCode;
	}

	public function getFhckCode()
	{
		return $this->fhckCode;
	}
	...
	public function setMxList($mxList)
	{
		$this->mxList = $mxList;
		$this->apiParas["mx_list"] = $mxList;
	}
	...
	{
		return "qimen.taobao.pos.update.salesorder";
	}
