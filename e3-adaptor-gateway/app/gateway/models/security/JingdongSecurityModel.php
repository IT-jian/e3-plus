    ...
    public static function encrypt($data)
    {
        ...
        foreach ((array)$data as $key=>$value) {
            ...
            try {
                ...
                CommonTool::errorLog("Encrypt Field[{$key}]:[{$value}] Failed. Exception:" . $e->getMessage());
                continue;
            }
        }
        return $data;
    ...
    public static function decrypt($data)
    {
        ...
        foreach ((array)$data as $key=>$value) {
            ...
            try {
                ...
                CommonTool::errorLog("Decrypt Field[{$key}]:[{$value}] Failed. Exception:" . $e->getMessage());
                continue;
            }
        }
        return $data;
