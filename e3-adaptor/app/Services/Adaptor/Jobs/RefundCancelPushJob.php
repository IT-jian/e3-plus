...
/**
 * 订单已经发货，消费者申请退运费等部分只退款不退货的退款请求，发货之后仅退款，取消申请退款
 *
 * Class RefundCancelPushJob
 * @package App\Services\Adaptor\Jobs
 *
 * @author linqihai
 * @since 2020/1/12 13:56
 */
class RefundCancelPushJob extends BasePushJob
{
    // 重试次数
    public $tries = 5;
    ...
    /**
     * RefundCancelPushJob constructor.
     * @param $stdRefund
     */
    ...
    public function handle()
    {
        ...
        // 校验仅同步一次
        if ($stdRefund) {
            $result = HubClient::refundCancel($stdRefund->toArray());
