 ...
 */
class RefundApplyDownloadJob extends BaseDownloadJob
{
    private $params;
    /**
     * RefundDownloadJob constructor.
     *
     * @param $params
     */
    ...
    {
        Adaptor::platform('jingdong')->download(AdaptorTypeEnum::REFUND_APPLY, $this->params);
    }
