...
class ExchangeBatchTransferJob extends BaseTransferJob
{
    private $params;
    ...
    {
        Adaptor::platform('taobao')->transfer(AdaptorTypeEnum::EXCHANGE_BATCH, $this->params);
    }
