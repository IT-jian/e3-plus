 ...
 */
class WareReadSearchWare4RecycledRequest extends JosRequest
{
    /**
     * @var string
     * @see https://open.jd.com/home/home#/doc/api?apiCateId=48&apiId=1587&apiName=jingdong.ware.read.searchWare4Valid
     */
    protected $apiName = 'jingdong.ware.read.searchWare4Recycled';
    ...
    protected $commaSeparatedParams = ['wareId', 'field', 'wareStatusValue'];
