...
class BaozunWmsClient implements WmsClientContract
{
    ...
    {
        $className = '\App\Services\Wms\Baozun\Adidas\Request\\';
        $className .= ucfirst($method).'Request';
        if (!class_exists($className)) {
            throw new \BadMethodCallException('No Such Wms Baozun Adidas API ' . $method);
        }
